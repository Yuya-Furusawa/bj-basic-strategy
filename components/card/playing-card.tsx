...
const CARD_IMAGES: Record<string, ImageSource> = {
  ...
  J_of_hearts: require('../../assets/cards/jack_of_hearts2.svg'),
  J_of_diamonds: require('../../assets/cards/jack_of_diamonds2.svg'),
  J_of_clubs: require('../../assets/cards/jack_of_clubs2.svg'),
  J_of_spades: require('../../assets/cards/jack_of_spades2.svg'),
  Q_of_hearts: require('../../assets/cards/queen_of_hearts2.svg'),
  Q_of_diamonds: require('../../assets/cards/queen_of_diamonds2.svg'),
  Q_of_clubs: require('../../assets/cards/queen_of_clubs2.svg'),
  Q_of_spades: require('../../assets/cards/queen_of_spades2.svg'),
  K_of_hearts: require('../../assets/cards/king_of_hearts2.svg'),
  K_of_diamonds: require('../../assets/cards/king_of_diamonds2.svg'),
  K_of_clubs: require('../../assets/cards/king_of_clubs2.svg'),
  K_of_spades: require('../../assets/cards/king_of_spades2.svg'),
